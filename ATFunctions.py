...
def ManualOrganizeImages(BID, ManualColNodeList, ManualNrmNodeList):
    blend_file_path = bpy.data.filepath
    blend_file_directory = os.path.dirname(blend_file_path)
    ...
    if blend_file_path:
        for Colnode in ManualColNodeList:
            ...
            print(Colnode.image.name)
            SavePILImage(blend_file_directory, BID, Colnode, ColTex)
