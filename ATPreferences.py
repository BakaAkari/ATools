...
class AT_AddonPreferences(AddonPreferences):
    ...
    def draw(self, context):
        ...
        # col.operator('object.atimportaddons', text='Update Plugins')
        col.operator('object.atinstallpil', text='Install PIL')
        col.operator(AT_DefaultSetting.bl_idname, text="Optimize Blender settings")

class AT_InstallPIL(bpy.types.Operator):
    bl_idname = "object.atinstallpil"
    bl_label = "安装PIL库"
...
class AT_DefaultSetting(bpy.types.Operator):
...
classes = (AT_InstallPIL, AT_AddonPreferences, AT_DefaultSetting)
